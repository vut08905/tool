...
APP_VERSION = "4.6"     # Phiên bản cứng của bản Build này
    ...
    def _load_cloud_config(self):
        ...
        def fetch():
            ...
            try:
                ...
                # So sánh version đúng chuẩn: chỉ update khi Cloud MỚI HƠN app hiện tại
                def _parse_ver(v):
                    try: return tuple(int(x) for x in str(v).split('.'))
                    except: return (0,)
                if _parse_ver(cloud_ver) > _parse_ver(my_ver):
